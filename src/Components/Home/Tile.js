...
<p className='font-bold  text-lg md:text-xl okay-bold'>$20</p>
<p>Price</p>
</div>
 ...
 <div className='second-second'>
  ...
  <div className='progress-bar-div flex justify-between text-sm text-slate-600'>
    ...
    <div className='w-full third'>
      ...
      <div className='third-buttons-first px-1'></div>
     <div className='third-buttons-first ml-2 px-1'></div>
      </div>
      <div className='third-second flex '>
         <div className='third-buttons-second px-1'></div>
     </div>
    </div>
